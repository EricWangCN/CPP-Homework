    ...
    while (choice != 0) {
        ...
        switch (choice) {
            case 1: {
                ...
                char a[1000], b[1000];
                cin >> s.number >> a >> b >> s.score;
                s.name.set_string(a);
                s.major.set_string(b);
            ...
            case 2: {
                ...
                cin >> num;
                switch (num) {
                    case '1': stuMng.display();
                        break;
                    case '2': long number; cout << "Please input number:"; cin >> number; stuMng.display(number);
                        break;
                    case '3': double score; cout << "Please input number:"; cin >> score; stuMng.display(score);
                        break;
                    case '4': double min,max; cout << "Please input range (min,max):"; cin >> min >> max; stuMng.display(min, max);
                        break;
